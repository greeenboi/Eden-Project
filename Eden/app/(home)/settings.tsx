            ...
            <CardContent className="gap-3">
              {section.items.map((item, itemIndex) => (
                <View key={itemIndex} style={{backgroundColor:"transparent"}}>
                  {item.type === 'switch' ? (
                    <View style={{backgroundColor:"transparent"}} className="flex-row items-center justify-between py-2">
                      <View style={{backgroundColor:"transparent"}} className="flex-row items-center gap-3 flex-1">
                        ...
                        <View style={{backgroundColor:"transparent"}} className="flex-1">
                          <Label nativeID={`switch-${index}-${itemIndex}`}>{item.label}</Label>
              ...
              <View style={{backgroundColor:"transparent"}} className="flex-row items-center justify-between py-3">
                <View style={{backgroundColor:"transparent"}} className="flex-row items-center gap-3">
                  ...
                  <View style={{backgroundColor:"transparent"}}>
                    <Text className="text-base font-medium">Credits & About</Text>
                    <Text className="text-sm opacity-70">App version & contributors</Text>
                  </View>
                </View>
                <Text className="opacity-50">→</Text>
              </View>
