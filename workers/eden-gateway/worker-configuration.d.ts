/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 57f7f2d50e4e3b5ef6f9152922da41c2)
// Runtime types generated with workerd@1.20260410.1 2025-12-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DownloaderQueueDO";
	}
	interface Env {
		DOWNLOADER_SERVICE_URL: string;
		DOWNLOADER_QUEUE: DurableObjectNamespace<import("./src/index").DownloaderQueueDO>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DOWNLOADER_SERVICE_URL">> {}
}
